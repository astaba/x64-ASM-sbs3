...
; Page 200: Multiplication with implicit operand

; First try a small multiplication that won't overflow to the high-order
; register, is this case edx
  ; mov eax,447
  ; mov ebx,1739
  ; mul ebx          ; product moved to eax and edx is zeroed out.

; Next a multiplication that overflows to the high-order register
  mov eax,0xFFFFFFFF
  mov ebx,0x3B72
  mul ebx           ; check the RFLAGS: CF is set
