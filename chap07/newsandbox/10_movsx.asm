; x64ASM_sbs4/chap07/newsandbox/09_movsx.asm
...
; Moving 1 byte signed value into a bigger register and loosing the signed bit
  ...
  mov ax,-42         ; loads 0xFFD6 because AX is 16-bit (not 8-bit).
  movsx rbx,ax       ; Move with Sign Extension takes the sign bit from 16-bit
                     ; quantity in AX and extends it to be the sign bit of
                     ; the 64-bit quantity in RBX
